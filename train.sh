...
CUDA_VISIBLE_DEVICES=1,2,3,4 python -m torch.distributed.launch --nproc_per_node=4 --master_port 29700 opengait/main.py --cfgs configs/biggergait/biggergait__DINOv2_Group_CCPG_Simple.yaml --phase train --log_to_file